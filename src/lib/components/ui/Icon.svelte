<script lang="ts">
	...
	const icons: Record<string, string> = {
		...
		// Snow - cloud with snowflakes (using proper path commands for snowflakes)
		snow: 'M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM19 18H6c-2.21 0-4-1.79-4-4s1.79-4 4-4h.71C7.37 7.69 9.48 6 12 6c3.04 0 5.5 2.46 5.5 5.5v.5H19c1.1 0 2 .9 2 2s-.9 2-2 2zM7.3 19.8L8 20.5L8.7 19.8L8 19.1L7.3 19.8ZM11.3 20.8L12 21.5L12.7 20.8L12 20.1L11.3 20.8ZM15.3 19.8L16 20.5L16.7 19.8L16 19.1L15.3 19.8Z',
